...
class GraphicsWrapper {
	...
	//TODO:
	public Point2D getMiddleOfLine(Point2D point1, Point2D point2){
	...
	public double getAngleBetweenTwoLines( Point2D pointCentre, Point2D pointDistant1, Point2D pointDistant2 ){
		...
		float y1 = pointDistant1.y() - pointCentre.y();
		float x2 = pointDistant2.x() - pointCentre.x();
		float y2 = pointDistant2.y() - pointCentre.y();
		
		System.out.println("point1:" + x1 + " " + y1);
		System.out.println("point2:" + x2 + " " + y2);
		
		double ProduitVectoriel = (x1*x2) + (y1*y2);
		double NormeLigne1 = Math.sqrt(  (x1*x1) + (y1*y1) );
		double NormeLigne2 =  Math.sqrt(  (x2*x2) + (y2*y2) );
		
		System.out.println("ProduitVectoriel: " + ProduitVectoriel);
		System.out.println("NormeLigne1: " + NormeLigne1);
		System.out.println("NormeLigne2: " + NormeLigne2);
		
		angleRad = Math.acos(ProduitVectoriel / (NormeLigne1*NormeLigne2));
		System.out.println("angle:" + angleRad);
		angle = angleRad*(360/(2*3.1416));
